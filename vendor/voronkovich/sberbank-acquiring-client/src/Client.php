...
class Client
{
    ...
    const API_PREFIX_DEFAULT = '/sbercredit/';
     ...
     */
    public function registerOrder($orderId, int $amount, string $returnUrl, array $orderBundle, array $jsonParams, array $data = []): array
    {
        

        return $this->doRegisterOrder($orderId, $amount, $returnUrl, $orderBundle, $jsonParams, $data, $this->prefixDefault . 'register.do');
    }
    ...
    {
        return $this->doRegisterOrder($orderId, $amount, $returnUrl, $data, $jsonParams, $this->prefixDefault . 'registerPreAuth.do');
    }

    public function doRegisterOrder($orderId, int $amount, string $returnUrl, array $orderBundle, array $jsonParams, array $data = [], $method = 'register.do'): array
    {
